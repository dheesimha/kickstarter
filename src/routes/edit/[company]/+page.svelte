        ...
        <div class="step step-1 active bg-kick-gold">
          ...
          <div class="form-group bg-kick-gold">
            ...
            >
              ...
              <option value="Advertising Exchanges"
                >Advertising Exchanges</option
              >
              <option value="Advertising Networks">Advertising Networks</option>
              <option value="Advertising Platforms"
                >Advertising Platforms</option
              >
              ...
              <option value="Application Platforms"
                >Application Platforms</option
              >
              ...
              <option value="Assisitive Technology"
                >Assisitive Technology</option
              >
              ...
              <option value="Enterprise Purchasing"
                >Enterprise Purchasing</option
              >
              ...
              <option value="Facebook Applications"
                >Facebook Applications</option
              >
              ...
              <option value="Government Innovation"
                >Government Innovation</option
              >
              ...
              <option value="Internet Radio Market"
                >Internet Radio Market</option
              >
              ...
              <option value="Medical Professionals"
                >Medical Professionals</option
              >
              ...
              <option value="Mobile Infrastructure"
                >Mobile Infrastructure</option
              >
              ...
              <option value="Mobile Software Tools"
                >Mobile Software Tools</option
              >
              ...
              <option value="Multi-level Marketing"
                >Multi-level Marketing</option
              >
              ...
              <option value="Productivity Software"
                >Productivity Software</option
              >
              ...
              <option value="Real Estate Investors"
                >Real Estate Investors</option
              >
              ...
              <option value="Unifed Communications"
                >Unifed Communications</option
              >
              ...
              <option value="Utility Land Vehicles"
                >Utility Land Vehicles</option
              >
